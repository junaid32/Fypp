          ...
          FB.login(function(myresponse) {
              if (myresponse.authResponse) {
                 ...
                 // document.getElementById('status').innerHTML = 'We are connected.';
                  ...
                  FB.api('/me/posts?limit=50','GET', function(myresponse) {
 ...
 /* $outputJSONButton.click(function() {
  ...
  function updateJSON(results) {
    ...
    $('.code--json').each(function (i,b) { hljs.highlightBlock(b);});
      ...
      //console.log(obj.personality[0].children[0].percentile);
      //console.log(obj.tree.children[0].children[0].children[0]*100);
      //setTimeout(function(){
